...
<!--                 <a href="" class="ov_listall">전체목록</a> -->
            ...
            <div class="formTitle">배송현황 리스트 <span>검색조건에 해당하는 리스트를 확인 할수 있습니다.</span></div>
						...
						<tbody>
							...
							<c:choose>
								...
								<tr>
									...
									<td class="listData" id="orderId_<c:out value="${aDeliveryList.orderId}" />"><c:out value="【${aDeliveryList.orderId}】" /></td>
									<td class="listData"><c:out value="${aDeliveryList.goodsNo}" /></td>
									<td class="listDataTitle txt-left">
										 <nobr>
											<b><a href="/"><c:out value="${aDeliveryList.goodsNm}" /></a></b>
										</nobr>
									</td>
									<td class="listData"><c:out value="${aDeliveryList.memId}" /></td>
									<td class="listData"><c:out value="${aDeliveryList.orderDate}" /></td>
									<td class="listData"><c:out value="${aDeliveryList.recipient}" /></td>
									<td class="listData"><c:out value="${aDeliveryList.orderZipcode}" /></td>
									<td class="listData"><c:out value="${aDeliveryList.orderAddr}" /><br><c:out value="${aDeliveryList.orderSub }" /></td>
									<td class="listData"><c:out value="${aDeliveryList.postCode }" /></td>
